...
import federates.ambassadors.ExampleFederateAmbassador;
...
public class ExampleFederate {
    ...
    private short getTimeAsShort() {
        return (short) fedamb.getFederateTime();
    }
    ...
    public AttributeHandle getFlavHandle() {
        return flavHandle;
    }

    public AttributeHandle getCupsHandle() {
        return cupsHandle;
    }

    public InteractionClassHandle getServedHandle() {
        return servedHandle;
    }
}
