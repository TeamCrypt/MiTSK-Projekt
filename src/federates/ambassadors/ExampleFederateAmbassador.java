...
import federates.ExampleFederate;
...
public class ExampleFederateAmbassador extends NullFederateAmbassador {
    ...
    private String decodeFlavor(byte[] bytes) {
        HLAinteger32BE value = federate.getEncoderFactory().createHLAinteger32BE();
        // decode
        try {
            value.decode(bytes);
    ...
    private short decodeNumCups(byte[] bytes) {
        HLAinteger16BE value = federate.getEncoderFactory().createHLAinteger16BE();
        // decode
        try {
            value.decode(bytes);
    ...
    public void reflectAttributeValues(ObjectInstanceHandle theObject,
        ...
        for (AttributeHandle attributeHandle : theAttributes.keySet()) {
            ...
            if (attributeHandle.equals(federate.getFlavHandle())) {
                builder.append(attributeHandle);
                builder.append(" (Flavor)    ");
                builder.append(", attributeValue=");
                builder.append(decodeFlavor(theAttributes.get(attributeHandle)));
            } else if (attributeHandle.equals(federate.getCupsHandle())) {
                builder.append(attributeHandle);
    ...
    public void receiveInteraction(InteractionClassHandle interactionClass,
        ...
        if (interactionClass.equals(federate.getServedHandle())) {
    ...
    public ExampleFederateAmbassador setIsAdvancing(boolean isAdvancing) {
