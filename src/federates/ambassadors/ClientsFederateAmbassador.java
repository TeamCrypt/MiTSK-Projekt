 ...
 * {@link ClientsFederate}. It will log information about any callbacks it
...
public class ClientsFederateAmbassador extends NullFederateAmbassador {
    ...
    //                   INSTANCE VARIABLES
    //----------------------------------------------------------
    private ClientsFederate federate;
    ...
    public ClientsFederateAmbassador(ClientsFederate federate) {
    ...
    public ClientsFederateAmbassador setIsAdvancing(boolean isAdvancing) {
